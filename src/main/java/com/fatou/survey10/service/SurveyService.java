package com.fatou.survey10.service;
...
public class SurveyService {
	...
	static {
		...
		Question question4 = new Question("Question4",
				"Second Largest english speaking contry in the World", "India", Arrays.asList(
						"India", "Russia", "United States", "China"));
	...
	public List<Question> retrieveQuestion(String surveyId){
